...
def generate_launch_description():
	...
	Astra_ProPlus = IncludeLaunchDescription(
	PythonLaunchDescriptionSource(os.path.join(astra_launch_dir,'astra_pro_plus.launch.py')),)
	...
	#Astra_S、Astra_Pro、Astra_ProPlus、Dabai、Gemini、Wheeltec_Usbcam
